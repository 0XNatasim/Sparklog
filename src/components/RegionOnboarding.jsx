...
export default function RegionOnboarding() {
  ...
  useEffect(() => {
    ...
    // Administration (office, non-CCQ) staff have no CCQ card, region or union
    // association, so skip the onboarding prompts entirely for them.
    if (isAdminEmployee(role)) return;
