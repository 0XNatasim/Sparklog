// Lightweight styled native <select> wrapper to preserve form behavior.
// Provides Select, SelectTrigger, SelectContent, SelectItem etc names too,
// but the simple use case (native) is what SparkLog needs for dynamic options.
